...
import (
	...
	"github.com/yourusername/go-htmx-oauth-mysql/internal/database"
	"github.com/yourusername/go-htmx-oauth-mysql/internal/handlers"
...
func main() {
	...
	// ハンドラー初期化
	authHandler := handlers.NewAuthHandler(config, store, userRepo)
	...
	protected.Use(middleware.AuthRequired(store, userRepo))
